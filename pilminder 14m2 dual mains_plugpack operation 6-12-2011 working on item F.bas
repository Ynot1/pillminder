'TIMING TEST RESULTS
'sort of works, but will stuff up regular med cycles as it dumps timer values on prempt
...
symbol 	IR_Threshold = 40 'was 150		;  slice level for deciding if bottle present or not
...
'CalibrateTouch2:
'something odd with using this section of code. stalls program.
