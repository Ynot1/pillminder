...
wait_Second_Flag_Demo:   	
	...
	If Second_Flag = 0 then 	
      ...
      Else
            ...
            if Sched_Bottle_Check_Flag = 0 and Demo_counter > Demo_Interval then
    			gosub Remind_demo
    		'else
    			
    		endif	
    		
    		gosub Is_Bottle_Back_Check_demo	'checks if time to squeal at user for not putting bottle back
